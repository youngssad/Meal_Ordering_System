...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	%>
		...
		<tr>
			<td  class="line_table" height="25" align="right" width="20%"><span class="left_bt2">Name：</span></td>
			<td class="line_table" height="25"  width="70%">
			<input type="text" name="name" size="45" readonly value="<%=menus.getName()%>"></td>
		</tr>
		<tr>
			<td  class="line_table" height="25"  align="right" width="20%"><span class="left_bt2">Material：</span></td>
			<td class="line_table" height="25" width="80%">
			<input type="text" name="burden" size="45" readonly value="<%=menus.getBurden()%>"></td>
		</tr>
		<tr>
			<td class="line_table" height="25"  align="right" width="20%"><span class="left_bt2">Market price：</span></td>
			<td height="25"  width="80%">
			<input type="text" name="price" size="45" readonly value="<%=menus.getPrice()%>"></td>
		</tr>
		<tr>
			<td class="line_table" height="25"  align="right" width="20%"><span class="left_bt2">Member price：</span></td>
			<td height="25"  width="80%">
			<input type="text" name="price1" size="45" readonly value="<%=menus.getPrice1()%>"></td>
		</tr>
		<tr>
			<td class="line_table"  height="25"  align="right" width="20%"><span class="left_bt2">Introduction：</span></td>
			<td class="line_table" height="25"  width="80%">
			<textarea rows="12" name="brief" cols="100" readonly><%=menus.getBrief()%></textarea></td>
		</tr>
		<tr>
			<td  class="line_table" height="25"  align="right" width="20%"><span class="left_bt2">Type：</span></td>
			<td  class="line_table"  height="25"  width="80%">
		...
		<tr>
			...
			<span class="left_bt2">Picture</span>：</td>
		...
		<tr>
			...
			<a href="index.jsp" target="_self"><input type="submit" value="Return"></a>
			</td>
		</tr>
