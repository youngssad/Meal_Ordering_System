				...
				<tr>
							...
							<table id="table2"   class="line_table" style="width: 700px; margin: 0; padding: 0" cellSpacing="0" cellPadding="0">
								...
								<tr >
									<td class="line_table" align="center" colspan="4" >
										<span class="left_bt2">Order list</span></td>
								</tr>
								<tr >
									<td class="line_table" align="center" width="40%" ><span class="left_bt2">Name</span></td>
									<td class="line_table" align="center" width="20%" ><span class="left_bt2">Price</span></td>
									<td class="line_table" align="center" width="20%"><span class="left_bt2">Number</span></td>
				  ...
				  %>
								<tr>
									...
									<td class="line_table" align="center" width="20%"><a href="/orders/order_shoppingcardel?del=<%=i%>">Cancel</a></td>
								</tr>
									<%
						}
		              }
					 ...
					 %>
								...
								<tr   >
									<td class="line_table" align="center"  colspan="4" >
										<span class="left_bt2">total：</span>&nbsp;
										<span  style="color:#ff0000;"><%=sum1 %></span>&nbsp;&nbsp;
										<span class="left_bt2">$</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="left_bt2">Total：</span>&nbsp;
