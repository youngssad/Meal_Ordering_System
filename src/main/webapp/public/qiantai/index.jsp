			...
			<td align="left" valign="top"><table width="100%" border="0"
                ...
                <div style="float:right;margin-right:10px;display:none"> <a href="-1" style="line-height:25px;color:">更多</a> </div>
																...
																<td style="margin-top: 10px;">
																	<div>
																		<table>
																			...
																			<tr>
																				<td><span>Markert price:</span></td>
																				<td><span><%=menus.getPrice()%></span></td>
																			</tr>
																			<tr>
																				<td><span>Member price:</span></td>
						...
						<td width="41%" align="right" valign="top"><table width="243"
													...
													<div
														...
														<div
															...
															<div
																...
																<a href="news/class/"
																	style="font: 12px/43px simsun; color: #505050; margin-right: 12px; display: inline">More&gt;&gt;</a>
															</div>
														</div>
								...
								<tr>
									<td valign="top">
										<div id='pdv_3614' class='pdv_class' title='My cart'
															...
															<div id="dingcanche2">
																...
																<table width="100%" border="0" cellspacing="0"
																	...
																	<tr>
																		...
																		<td align="center"><a
																			href="/orders/order_shoppingcardel?del=<%=i%>">Cancel</a></td>
																	</tr>
																	<%
																		}}
																	%>
																...
																<div style="height: 24px; margin: 5px 3px 1px 3px;">
																	<div
																		style="float: left; line-height: 24px; padding-left: 25px;">Total：</div>
																	<div
																		style="float: right; line-height: 24px; padding-right: 15px;">
																		<font id="allnums" style="color: #ff0000;"><%=sum2%></font>Piece
																	</div>
																	<div
																		style="float: right; line-height: 24px; padding-right: 30px;">
																		<font id="cpprice" style="color: #ff0000;"><%=sum1%></font>$
																	</div>
																</div>
																	...
																	<div class="dingcanweekmenuinfo" align="left">
																		...
																		<%
																			for (int i = 0; i < menusList.size(); i++) {
																				...
																				String str = "";
																				str = "Sold" + menus1.getSums1() + "times";
																		%>
