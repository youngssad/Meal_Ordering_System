...
<script language="JavaScript">
	function check11() {
		...
		if (document.form1.name.value == "") {
			alert("Menu name cant be empty!");
			document.form1.name.focus();
			return false;
		}
		if (document.form1.burden.value == "") {
			alert("Material cant be empty!");
			document.form1.author.focus();
			return false;
		}
		if (document.form1.price.value == "") {
			alert("Market price cant be empty!");
			document.form1.price1.focus();
			return false;
		}
		if (document.form1.price1.value == "") {
			alert("Member price cant be empty!");
			document.form1.price1.focus();
			return false;
		}
		if (document.form1.brief.value == "") {
			alert("Introduction cant be empty!");
	...
	<table width="100%" height="1" border="0" cellpadding="0"
		...
		<tr>
			...
			<td valign="top" background="../public/admin/images/content-bg.gif"><table
					...
					<tr>
						<td height="31"><div class="titlebt">Add Meal</div></td>
					</tr>
				</table></td>
						...
						<table id="table2" class="line_table"
							...
							<tr>
								<td class="line_table" height="25" align="right" width="20%"><span
									class="left_bt2">Meal name：</span></td>
							...
							<tr>
								<td class="line_table" height="25" align="right" width="20%"><span
									class="left_bt2">Meal type：</span></td>
