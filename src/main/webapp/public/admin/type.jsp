	...
	<table width="100%" height="1" border="0" cellpadding="0"
		...
		<tr>
			...
			<td valign="top" background="../public/admin/images/content-bg.gif"><table
					...
					<tr>
						<td height="31"><div class="titlebt">Type Information</div></td>
					</tr>
				</table></td>
						...
						<tbody style="margin: 0; padding: 0">
							<tr>
								<td class="line_table" align="center" colspan="8" height="20">
									<span class="left_bt2">Type Information List</span>
								</td>
							</tr>
							<tr>
								<td class="line_table" align="center" width="30%"><span
									class="left_bt2">Type ID</span></td>
								<td class="line_table" align="center" width="30%"><span
									class="left_bt2">Type Name</span></td>
							...
							<tr>
								...
								<td class="line_table" align="center" width="20%"><a
                                        href="<c:url value="/types/queryById?id=${t.id}"/>" target="main">Modify</a></td>
								<td class="line_table" align="center" width="20%"><a
									href="<c:url value="/types/delete?id=${t.id}"/>" target="main">Delete</a></td>
							</tr>
							</c:forEach>
