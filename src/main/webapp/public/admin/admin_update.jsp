	...
	<table width="100%" height="1" border="0" cellpadding="0"
		...
		<tr>
			...
			<td valign="top" background="images/content-bg.gif"><table
					...
					<tr>
						<td height="31"><div class="titlebt">Manager information</div></td>
					</tr>
				</table></td>
							...
							<tbody style="margin: 0; padding: 0">
								<tr>
									<td class="line_table" align="center" colspan="8" height="20">
										<span class="left_bt2">Modify manager information</span>
									</td>
								</tr>
								<%
