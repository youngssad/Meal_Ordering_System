	...
	<table width="100%" height="1" border="0" cellpadding="0"
		...
		<tr>
			...
			<td valign="top" background="../public/admin/images/content-bg.gif"><table
					...
					<tr>
						<td height="31"><div class="titlebt">Announcement</div></td>
					</tr>
				</table></td>
						...
						<tbody style="margin: 0; padding: 0">
							<tr>
								<td class="line_table" align="center" colspan="8" height="20">
									<span class="left_bt2">Announcement List</span>
								</td>
							</tr>
							<tr>
								<td class="line_table" align="center" width="25%"><span
									class="left_bt2">Title</span></td>
								<td class="line_table" align="center" width="40%"><span
									class="left_bt2">Information</span></td>
								<td class="line_table" align="center" width="21%"><span
									class="left_bt2">Announcement time</span></td>
							...
							<tr>
								...
								<td class="line_table" align="center" width="7%"><a
									href="<c:url value="/notice/queryById?id=${t.id}"/>">Modify</a></td>
								<td class="line_table" align="center" width="7%"><a
									href="<c:url value="/notice/delete?id=${t.id}"/>">Delete</a></td>
							</tr>
							</c:forEach>
					</table>
				</div>
